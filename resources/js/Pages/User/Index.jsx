...
import {archiveBoxXMark,PhotoIcon,UserCircleIcon} from '@heroicons/react/24/outline'
                ...
                <form onSubmit={save} className="p-6">
                    ...
                    <div>                        
                        <Select
                            ...
                            id="id_user_type"
                            name="id_user_type"
                            input={id_user_typeInput}                            
                            required
                            isFocused={true}
                            handleChange={(e) => setData('id_user_type', e.target.value)}
                            options={props.user_types}
                        >                                 
                        </Select>
